...
## Инструкции
1. Открыть ноутбук в колабе. Его можно скачать из репозитория или открыть по ссылке: 
...
<img src="https://github.com/maksonchek/cv_hotels/blob/main/Assets/6.jpg">   
...
Были отсеяны те отели, на фотографиях которых модеть не нашла море.
К оставшимся бвли добавлены следующие теги (подробнее в колабе):
...
Для изменений были выбраны самые красивые, на мой взгляд, изображения лучших отелей, которые будут рекомендованы кеплеровцам. Здесь приведу наилучшие результаты применения модели DiffusionMagic
